/* src/config/btq-config.h.  Generated from btq-config.h.in by configure.  */
/* src/config/btq-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BTQ Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BTQ Core"
...
#define PACKAGE_BUGREPORT "https://github.com/btq/btq/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BTQ Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BTQ Core 0.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "btq"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://btqcore.org/"
