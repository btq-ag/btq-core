...
The BTQ Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "BTQ Core
...
Before you start contributing, familiarize yourself with the BTQ Core build
system and tests. Refer to the documentation in the repository on how to build
BTQ Core and how to run the unit tests, functional tests, and fuzz tests.
...
[BTQ Core PR Review Club](https://btqcore.reviews/) meeting.
...
Most communication about BTQ Core development happens on IRC, in the
`#btq-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#btq-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/btq-core-dev/](https://www.erisian.com.au/btq-core-dev/)
and [https://gnusha.org/btq-core-dev/](https://gnusha.org/btq-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/btq-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to btq-qt
...
fork of BTQ Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the BTQ Core project (and related
projects such as libsecp256k1), and is not to be confused with overall BTQ
Network Protocol consensus changes.

Whether a pull request is merged into BTQ Core rests with the project merge
maintainers.
...
Patches that change BTQ consensus rules are considerably more involved than
...
Where a patch set proposes to change the BTQ consensus, it must have been
