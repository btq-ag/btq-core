...
export CONTAINER_NAME=ci_native_nowallet_libbtqkernel
...
export GOAL="install"
export BTQ_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
