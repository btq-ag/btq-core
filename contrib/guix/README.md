# Bootstrappable BTQ Core Builds

This directory contains the files necessary to perform bootstrappable BTQ
Core builds.
...
To build BTQ Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/btq-detached-sigs> ./contrib/guix/guix-codesign
```
