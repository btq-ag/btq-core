...
"""Example logging BTQ Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/btqd
...
def main(btqd_path):
    ...
    b = BPF(text=program, usdt_contexts=[btqd_with_usdts])
