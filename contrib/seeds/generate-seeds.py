...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BTQ_CHAINPARAMSSEEDS_H\n')
    g.write('#define BTQ_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the btq network\n')
    ...
    g.write('#endif // BTQ_CHAINPARAMSSEEDS_H\n')
