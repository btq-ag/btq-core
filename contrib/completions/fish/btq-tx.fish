...
# Extract options
function __fish_btq_tx_get_options
...
# Extract commands
function __fish_btq_tx_get_commands
...
complete \
    --command btq-tx \
    --condition "not __fish_btq_seen_cmd (__fish_btq_tx_get_commands --commandsonly)" \
    --arguments "(__fish_btq_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command btq-tx \
    --arguments "(__fish_btq_tx_get_commands)" \
    --no-files
