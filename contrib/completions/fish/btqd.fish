...
complete --command btqd --no-files

# Extract options
function __fish_btqd_get_options
...
complete \
    --command btqd \
    --arguments "(__fish_btqd_get_options --nofiles)"
