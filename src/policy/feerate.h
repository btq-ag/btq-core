...
#ifndef BTQ_POLICY_FEERATE_H
#define BTQ_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "BTQ"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BTC_KVB,      //!< Use BTQ/kvB fee rate unit
