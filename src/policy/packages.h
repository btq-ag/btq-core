...
#ifndef BTQ_POLICY_PACKAGES_H
#define BTQ_POLICY_PACKAGES_H
...
static constexpr uint32_t MAX_PACKAGE_WEIGHT = 8'000'000; // one 8 MW block (must be >= ancestor/descendant limits * WITNESS_SCALE_FACTOR * 1000)
