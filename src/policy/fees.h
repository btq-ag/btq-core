...
#ifndef BTQ_POLICY_FEES_H
#define BTQ_POLICY_FEES_H
...
private:
    ...
    /** Per-block sufficiency, scaled 10x down so 60s blocks keep Core's wall-clock sample. */
    static constexpr double SUFFICIENT_FEETXS = 0.01;
    /** Short-horizon sufficiency, same 10x wall-clock scaling as SUFFICIENT_FEETXS. */
