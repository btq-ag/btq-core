...
/** Main BTQ application object */
class BTQApplication: public QApplication
{
    Q_OBJECT
public:
    explicit BTQApplication();
    ~BTQApplication();
    ...
    /// Get window identifier of QMainWindow (BTQGUI)
...
Q_SIGNALS:
    ...
    void windowShown(BTQGUI* window);
