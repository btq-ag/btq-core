...
#ifndef BTQ_QT_BTQUNITS_H
#define BTQ_QT_BTQUNITS_H
...
/** BTQ unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BTQUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BTQUnits(QObject *parent);

    /** BTQ units.
      @note Source: https://en.btq.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        BTQ,
        mBTC,
