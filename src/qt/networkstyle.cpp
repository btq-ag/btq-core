...
static const struct {
    ...
    {ChainType::BTQTEST, QAPP_APP_NAME_TESTNET, 0, 0},
    {ChainType::BTQSIGNET, QAPP_APP_NAME_SIGNET, 0, 0},
    {ChainType::BTQREGTEST, QAPP_APP_NAME_REGTEST, 0, 0},
};
