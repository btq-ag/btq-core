...
#ifndef BTQ_QT_BTQGUI_H
#define BTQ_QT_BTQGUI_H
...
/**
  BTQ GUI main class. This class represents the main window of the BTQ UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BTQGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BTQGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BTQGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a btq wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BTQUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed BTQ Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(BTQUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // BTQ_QT_BTQGUI_H
