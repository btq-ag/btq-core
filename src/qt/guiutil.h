...
#ifndef BTQ_QT_GUIUTIL_H
#define BTQ_QT_GUIUTIL_H
...
/** Utility functions used by the BTQ Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "btq:" URI into recipient object, return true on successful parsing
