    ...
    : QWidget()
{
    ...
    QString copyrightText   = QString::fromUtf8(CopyrightHolders(strprintf("\xc2\xA9 %u-%u ", BTQ_LAUNCH_YEAR, COPYRIGHT_YEAR)).c_str());
    ...
    // draw the btq icon, expected size of PNG: 1024x1024
