      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->btqAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->btqAtStartup);
    ...
    ui->btqAtStartup->setToolTip(ui->btqAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->btqAtStartup->setText(ui->btqAtStartup->text().arg(PACKAGE_NAME));

    ui->openBTQConfButton->setToolTip(ui->openBTQConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BTQUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->btqAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBTQConfButton_clicked()
{
