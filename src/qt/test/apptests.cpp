...
//! Entry point for BTQApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BTQApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BTQGUI tests.
void AppTests::guiTests(BTQGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BTQGUI::consoleShown, this, &AppTests::consoleTests);
