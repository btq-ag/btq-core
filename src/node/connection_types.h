...
#ifndef BTQ_NODE_CONNECTION_TYPES_H
#define BTQ_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/btq-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on BTQ’s Peer-to-Peer Network")
...
#endif // BTQ_NODE_CONNECTION_TYPES_H
