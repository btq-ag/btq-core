...
{
    const auto params {CreateChainParams(ArgsManager{}, ChainType::BTQMAIN)};
    ...
    // this is a check to make sure that https://github.com/btq/btq/issues/21379 does not recur
