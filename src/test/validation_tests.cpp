// Copyright (c) 2014-2021 The BTQ Core developers
...
{
    int maxHalvings = 64;
    CAmount nInitialSubsidy = 5 * COIN; // BTQ: 5 BTQ per block
...
BOOST_AUTO_TEST_CASE(block_subsidy_test)
{
    ...
    TestBlockSubsidyHalvings(1500); // As in regtest (BTQ: 10x Bitcoin for 1-min blocks)
...
BOOST_AUTO_TEST_CASE(subsidy_limit_test)
{
    ...
    BOOST_CHECK_EQUAL(nSum, CAmount{2099999972700000}); // BTQ: 5 BTQ/block, 2.1M halving interval
}
...
BOOST_AUTO_TEST_CASE(signet_parse_tests)
{
    ...
    const auto signet_params = CreateChainParams(signet_argsman, ChainType::BTQSIGNET);
    CBlock block;
