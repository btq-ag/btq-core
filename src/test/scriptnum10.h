...
#ifndef BTQ_TEST_SCRIPTNUM10_H
#define BTQ_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BTQ Core 0.10.0, for cross-comparison.
 */
public:
