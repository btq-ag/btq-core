...
BOOST_AUTO_TEST_CASE(versionbits_computeblockversion)
{
    ...
    for (const auto& chain_type: {ChainType::BTQMAIN, ChainType::BTQTEST, ChainType::BTQSIGNET, ChainType::BTQREGTEST}) {
...

    {
        ...
        const auto chainParams = CreateChainParams(args, ChainType::BTQREGTEST);
