// Copyright (c) 2019-2020 The BTQ Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BTQ_TEST_UTIL_TRANSACTION_UTILS_H
#define BTQ_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // BTQ_TEST_UTIL_TRANSACTION_UTILS_H
