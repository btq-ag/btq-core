...
{
    BOOST_CHECK(TestSplitHost("www.btqcore.org", "www.btqcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.btqcore.org]", "www.btqcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.btqcore.org:80", "www.btqcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.btqcore.org]:80", "www.btqcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.btqcore.org:65536", "www.btqcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.btqcore.org:0", "www.btqcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.btqcore.org:", "www.btqcore.org:", 0, false));
}
