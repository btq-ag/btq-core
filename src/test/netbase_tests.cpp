...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinquantum.com", "www.bitcoinquantum.com", 0));
    BOOST_CHECK(TestSplitHost("[www.bitcoinquantum.com]", "www.bitcoinquantum.com", 0));
    BOOST_CHECK(TestSplitHost("www.bitcoinquantum.com:80", "www.bitcoinquantum.com", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinquantum.com]:80", "www.bitcoinquantum.com", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.bitcoinquantum.com:65536", "www.bitcoinquantum.com:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoinquantum.com:0", "www.bitcoinquantum.com", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoinquantum.com:", "www.bitcoinquantum.com:", 0, false));
}
