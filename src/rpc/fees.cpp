...
static RPCHelpMan estimatesmartfee()
{
    return RPCHelpMan{"estimatesmartfee",
        ...
        "for which the estimate is valid. Blocks are 60 seconds. conf_target=60 is about\n"
        "one hour. Uses virtual transaction size (weight / 16; BTQ WITNESS_SCALE_FACTOR).\n",
        {
        ...
        RPCExamples{
            HelpExampleCli("estimatesmartfee", "60") +
            HelpExampleRpc("estimatesmartfee", "60")
        },
...
static RPCHelpMan estimaterawfee()
{
    return RPCHelpMan{"estimaterawfee",
        ...
        "\nEstimates the approximate fee per kilobyte needed for a transaction to begin\n"
        "confirmation within conf_target blocks if possible. Uses virtual transaction size\n"
        "(weight / 16; BTQ WITNESS_SCALE_FACTOR; witness data is discounted).\n",
        {
            {"conf_target", RPCArg::Type::NUM, RPCArg::Optional::NO, "Confirmation target in one-minute blocks (1 - 10080)"},
