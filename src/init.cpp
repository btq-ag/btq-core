...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-maxorphantx=<n>", "Deprecated. Orphanage eviction is by unique weight and latency score, not by a transaction count. The value is ignored.", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
