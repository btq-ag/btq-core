...
#ifndef BTQ_WALLET_SCRIPTPUBKEYMAN_H
#define BTQ_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BTQ Core wallet was originally a collection of unrelated private
...
#endif // BTQ_WALLET_SCRIPTPUBKEYMAN_H
