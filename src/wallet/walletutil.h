...
#ifndef BTQ_WALLET_WALLETUTIL_H
#define BTQ_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! btq from opening the wallet, thinking it was newly created, and
