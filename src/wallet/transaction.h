...
#ifndef BTQ_WALLET_TRANSACTION_H
#define BTQ_WALLET_TRANSACTION_H
...
public:
     ...
     * on this btq node, and set to 0 for transactions that were created
...
#endif // BTQ_WALLET_TRANSACTION_H
