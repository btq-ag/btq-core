...
#ifndef BTQ_INTERFACES_NODE_H
#define BTQ_INTERFACES_NODE_H
...
//! Top-level interface for a btq node (btqd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or btq.conf.
