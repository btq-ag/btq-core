 ...
 *  AppInitMain requires maxmempool >= descendant_size_vbytes * 40. With
 *  DEFAULT_DESCENDANT_SIZE_LIMIT_KVB at one default template (474 kvB) that
 *  floor is 19 MB. */
...
static_assert(DEFAULT_BLOCKSONLY_MAX_MEMPOOL_SIZE_MB >= 19);
