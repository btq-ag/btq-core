...
/** Bound announcer-set memory; each extra announcer is otherwise uncharged. */
static constexpr size_t MAX_ANNOUNCERS_PER_ORPHAN{10};
...
public:
    ...
    CTransactionRef GetTx(const GenTxid& gtxid) const EXCLUSIVE_LOCKS_REQUIRED(!m_mutex);
