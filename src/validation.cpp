...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (!ancestors) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/btq-dev/2018-November/016518.html
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    CAmount nSubsidy = 5 * COIN; // BTQ: 5 BTQ/block (1/10th Bitcoin, compensated by 10x more blocks)
                               ...
                               CCoinsViewCache& view, bool fJustCheck)
{
    ...
    // Also, currently the rule against blocks more than 15 minutes in the future
    // is enforced in ContextualCheckBlockHeader(); we wouldn't want to
    // re-enforce that rule here (at least until we make it impossible for
    // the system clock to go backward).
...
bool ChainstateManager::ProcessNewBlock(const std::shared_ptr<const CBlock>& block, bool force_processing, bool min_pow_checked, bool* new_block)
{
...

    {
        ...
        // https://lists.linuxfoundation.org/pipermail/btq-dev/2019-February/016697.html.  Because CheckBlock() is
