...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BTQTestFramework
    pass


class ExampleTest(BTQTestFramework):
    # Each functional test is a subclass of the BTQTestFramework class.
    ...
    def custom_method(self):
        ...
        BTQTestFramework class so other tests can use it."""
