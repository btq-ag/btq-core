...
class FullBlockTest(BTQTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure btqd isn't accepting b26
        ...
        # Extend the b28 chain to make sure btqd isn't accepting b28
        ...
        #    Low-S and High-S values (whereas the btq code has custom code which does so);
