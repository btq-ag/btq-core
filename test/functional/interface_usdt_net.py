...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/btq/btq/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(BTQTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our btqd node")
