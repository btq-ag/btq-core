#!/usr/bin/env python3
# Copyright (c) 2018-2021 The BTQ Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting btq with -h works as expected."""

from test_framework.test_framework import BTQTestFramework
from test_framework.util import assert_equal

class HelpTest(BTQTestFramework):
    ...
    def run_test(self):
        self.log.info("Start btq with -h for help text")
        ...
        self.log.info("Start btq with -version for version information")
        ...
        self.log.info("Start btqd with -fakearg to make sure it does not start")
