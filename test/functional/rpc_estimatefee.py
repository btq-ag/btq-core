...
class EstimateFeeTest(BTQTestFramework):
    ...
    def run_test(self):
        ...
        # max value of 10080 per src/policy/fees.h (one week of 60s blocks)
        assert_raises_rpc_error(-8, "Invalid conf_target, must be between 1 and 10080", self.nodes[0].estimaterawfee, 10081)
