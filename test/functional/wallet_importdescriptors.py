...
class ImportDescriptorsTest(BTQTestFramework):
    ...
    def run_test(self):
        ...
        addresses += ["qcrt1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju77h50u7", "qcrt1qfqeppuvj0ww98r6qghmdkj70tv8qpcheekrtu2"] # wpkh subscripts corresponding to the above addresses
        ...
        assert_equal(addr, 'qcrt1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fqzdef2d') # Derived at m/84'/0'/0'/0
        ...
        assert_equal(addr, 'qcrt1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeqm0qjd0') # Derived at m/84'/0'/0'/1
        change_addr = wmulti_pub.getrawchangeaddress('bech32') # uses change 2
        assert_equal(change_addr, 'qcrt1qp6j3jw8yetefte7kw6v5pc89rkgakzy98p6gf7ayslaveaxqyjusmm0epj') # Derived at m/84'/1'/0'/2
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=1) as thread:
            with self.nodes[0].assert_debug_log(expected_msgs=[f"Rescan started from block {self.nodes[0].getblockhash(0)}... (slow variant inspecting all blocks)"], timeout=5):
