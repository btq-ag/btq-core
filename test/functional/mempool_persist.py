...
By default, btqd will dump mempool on shutdown and
...
class MempoolPersistTest(BTQTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent btqd from writing mempool.dat to disk. Verify that `savemempool` fails")
