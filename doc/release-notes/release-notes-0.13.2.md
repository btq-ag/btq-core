BTQ Core version 0.13.2 is now available from:

  <https://btq.org/bin/btq-core-0.13.2/>
...
- #8908 `4a974b2` Update btq-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow btq-tx to create v2 transactions (btcdrak)
