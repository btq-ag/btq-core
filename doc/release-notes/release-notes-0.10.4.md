BTQ Core version 0.10.4 is now available from:

  <https://btq.org/bin/btq-core-0.10.4/>
...
- #6953 `43c2789` Split btq-tx into its own package
- #6953 `dfe0d4d` Include btq-tx binary on Debian/Ubuntu
