...
BTQ Core version 0.19.1 is now available from:

  <https://btqcore.org/bin/btq-core-0.19.1/>
...
From BTQ Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as BTQ Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, BTQ Core does not yet change appearance when
...
- #17488 fix "btqd already running" warnings on macOS (fanquake)
