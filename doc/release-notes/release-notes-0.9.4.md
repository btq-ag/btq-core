BTQ Core version 0.9.4 is now available from:

  https://btq.org/bin/0.9.4/
...
this update is incompatible with the BTQ system and could lead to consensus
forks.

BTQ Core released binaries from https://btq.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~btq/+archive/ubuntu/btq
- A third-party or self-compiled BTQ Core

upgrade to BTQ Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
