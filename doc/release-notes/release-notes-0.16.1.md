BTQ Core version 0.16.1 is now available from:

  <https://btqcore.org/bin/btq-core-0.16.1/>
...
- #12843 `df38b13` Test starting btqd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure btqd processes are cleaned up when tests end (sdaftuar)
