BTQ version 0.5.4 is now available for download at:
http://sourceforge.net/projects/btq/files/BTQ/btq-0.5.4/
...
http://gitorious.org/btq/btqd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BTQ-Qt notifications under Growl 1.3.
Increase required age of BTQ-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBTQ properly when installing BTQ-Qt over it. (Windows)
