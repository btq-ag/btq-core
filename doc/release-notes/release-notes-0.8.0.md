BTQ-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/btq/files/BTQ/btq-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BTQ
...
New/changed settings (command-line or btq.conf file)
--------------------------------------------------------
