...
* Opt-in full replace-by-fee (without inherited signaling) honoured in mempool and mining as of
  **v0.12.0** ([PR 6871](https://github.com/btq/btq/pull/6871)).

* [BIP125](https://github.com/btq/bips/blob/master/bip-0125.mediawiki) defined based on
  BTQ Core implementation.
