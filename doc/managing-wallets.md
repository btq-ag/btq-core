...
BTQ Core inherits HD wallets with deterministic key derivation from Bitcoin Core, which [introduced them in version 0.13](https://github.com/bitcoin/bitcoin/blob/master/doc/release-notes/release-notes-0.13.0.md). With HD wallets, users no longer lose funds when restoring old backups because all addresses are derived from the HD wallet seed.
